...
//import com.hanvon.sulupen.utils.MoreFunctionUtil;
...
public class SettingsActivity extends PreferenceActivity implements
	...
	private Preference mUpdateVersion;
	@Override
   ...
   //     mUpdateVersion=(Preference)this.findPreference(getString(R.string.setting_version_key));
		prefSet.setOnPreferenceChangeListener(this);
	//	mUpdateVersion.setOnPreferenceClickListener(this);
...
//		if(arg0==mUpdateVersion)
//		{
//			LogUtil.getInstance().i("checkVersion");
//			MoreFunctionUtil mUtil =new MoreFunctionUtil(SettingsActivity.this);
//			mUtil.checkVersion();
//		}
		return false;
	}
