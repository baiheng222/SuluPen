...
public class ImagePublishAdapter extends BaseAdapter {
	...
	private static String TAG = "ImagePublishAdapter";
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		LogUtil.i("tong-----------ImagePublish getView");
		...
		if (isShowAddItem(position)) {
			...
			LogUtil.i("tong-----------ImagePublish getView else");
			...
			LogUtil.i("tong-----------ImagePublish getView else end");
		}
